...
// //initialize logger and include configuration
...
// 	// Your Code Here (1).
// 	s.logger.Infof("standalone storage start...")
...
// //batch write for single writer type(put or delete)
...
// //reader implements StorageReader interface 
// //to fetch the value of indicated column family
